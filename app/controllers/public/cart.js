                    ...
                    response.dataset.map(function (row) {
                        ...
                        content += `
                            <tr>
                                ...
                                <td>
                                    <a href="#" onclick="openUpdateDialog(${row.id_detalle_pedido}, ${row.cantidad})" class="btn waves-effect blue tooltipped" data-tooltip="Cambiar" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="material-icons">exposure</i></a>
